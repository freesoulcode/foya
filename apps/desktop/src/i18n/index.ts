...
const ERROR_KEYS: Record<string, string> = {
  ...
  channel_binding_failed: "Failed to load channel binding",
  channel_unbind_failed: "Failed to unbind channel conversation",
  channel_pairing_failed: "Failed to create channel pairing",
  channel_pairing_not_found: "Channel pairing not found",
  interactive_session: "Set tool approval to Automatic or Full access before binding",
  feishu_registration_failed: "Failed to register Feishu channel",
