...
// DefinitionManager owns definition discovery. Definitions are read on every request so
...
func NewDefinitionManager(homeDir string, builtins []Definition) *DefinitionManager {
	...
	return &DefinitionManager{homeDir: homeDir, builtins: cloned}
}
...
func (m *DefinitionManager) List(ctx context.Context, projectID, projectPath string) ([]Definition, error) {
...
func (m *DefinitionManager) ListAll(_ context.Context, projectID, projectPath string) ([]Definition, error) {
