...
// promptEnvironmentInput contains dynamic environment details appended to each turn.
//
...
type promptEnvironmentInput struct {
	Cwd      string
...
func envFragment(in promptEnvironmentInput) string {
