...
func (b *Backend) InvocableSkills(ctx context.Context) ([]skill.Skill, error) {
...
func (b *Backend) InvocableProjectSkills(ctx context.Context, projectID string) ([]skill.Skill, error) {
	b.mu.RLock()
...
func (b *Backend) normalizeSelectedSkill(
	ctx context.Context,
